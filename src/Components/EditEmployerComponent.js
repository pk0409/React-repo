...
class EditEmployerComponent extends Component {
    ...
    editEmployer = (e) => {
        e.preventDefault();
        let employer = {
            id: this.state.id, organizationName: this.state.organizationName,
            address: this.state.address, contactNo: this.state.contactNo,
                        ...
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.editEmployer}>Update</button>
