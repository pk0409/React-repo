...
class CreateJobComponent extends Component {
    ...
    saveJob = (e)=>{
        ...
        if(isValid){
            let job ={ title: this.state.title, location: this.state.location, description: this.state.description,
            ...
            console.log(job);
            EmployerService.postAJob(job, this.state.employerId).then((res) => {
